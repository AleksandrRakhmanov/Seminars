      ...
      <div className={styles.seminarsContainer}>
        <div className={styles.allElementsInCard}>
          ...
          <div className={styles.imgAndElementsContainer}>
            <img className={styles.seminar_image} src={seminar.photo} alt="film" />
            <div className={styles.elements}>
              {/* <p className={styles.seminar_name}>Как деликатно сообщить коллеге, что от него плохо пахнет?</p> */}
              ...
              <div className={styles.description_container}>
                ...
                <p className={styles.description}>
                  ...
                  doloribus eligendi quo deserunt id mollitia fugit, corporis impedit
                  ducimus minus veniam nobis natus rerum harum commodi illo corrupti
                  maiores voluptatem aperiam vitae omnis dignissimos possimus porro
                  aspernatur! Explicabo sit repellendus dolores ratione quibusdam illo
                  corporis illum veritatis sunt quos, dicta accusantium distinctio
                  quis maiores necessitatibus numquam animi tenetur quam temporibus
                  est nisi nostrum eligendi. Quod, quidem nesciunt voluptas quo alias
                  sunt asperiores odio vero similique, tenetur eius ipsa culpa enim in
                  iusto veritatis eum. Ullam sequi quos a dicta saepe odio illo fugit
                  numquam fuga. Ipsum eos harum exercitationem mollitia!
                </p>
              </div>
        ...
        <div key={comment.id} className={styles.comment}>
            ...
            <div>
              ...
              {Array.from({length:comment.rating}).map((_, index) => (
                <img key={index} className={styles.comment_rate_icon} src={rate_icon} alt='rate_icon'/>
              ))}
            </div>
            </div>
            <div>
